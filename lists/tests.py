...
class NewItemTest(TestCase):
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        self.client.post('/lists/'+str(correct_list.id)+'/add_item',data={'item_text': 'A new item for an existing list'})
    ...
    def test_redirects_to_list_view(self):
        ...
        response = self.client.post('/lists/'+str(correct_list.id)+'/add_item',data={'item_text': 'A new item for an existing user'})
