...
class newVisitorTest(LiveServerTestCase):
    ...
    # Any method whose name starts with test is a test method and will be 
    # run by the test runner.
    # You can have multiple test_ method per class, descriptive names are 
    # better
    ...
    def test_multiple_users_can_start_lists_add_different_urls(self):
        ...
        # Francis visits the homep age. There is no sign of Edith's list
        self.browser.get(self.live_server_url)
        page_text = self.browser.find_element_by_tag_name('body').text
